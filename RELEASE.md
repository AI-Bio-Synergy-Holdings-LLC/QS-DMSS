...
Current release target: `v0.1.2` / `0.1.2`. Published release-candidate tags
...
- Python package metadata uses the equivalent PEP 440 form, such as
  `0.1.0rc1`.
- Final releases use matching final versions: Git tags such as `v0.1.2` and
  package versions such as `0.1.2`.
