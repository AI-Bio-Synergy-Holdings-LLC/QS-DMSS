...
Prepare the packet, collect reviewer feedback, and use `v0.11.0` as the stable
...
| Installable package | PyPI `qs-dmss==0.11.0`, release wheel, Trusted Publishing, fresh-install smoke | Ready | `v0.11.0` carries the Hosted Studio cockpit, scientific comparison workbooks, Fractal/Quadrant SSFM validation spine, public reference-data provenance sandbox, Conceptual Reference Map links, and job-registry path hardening; the latest archived DOI remains `10.5281/zenodo.21270512` until Zenodo archives v0.11.0 |
