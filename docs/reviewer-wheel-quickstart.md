...
Wheel:
`https://github.com/AI-Bio-Synergy-Holdings-LLC/QS-DMSS/releases/download/v0.10.1/qs_dmss-0.10.1-py3-none-any.whl`
...
```powershell
$release = "https://github.com/AI-Bio-Synergy-Holdings-LLC/QS-DMSS/releases/download/v0.10.1"
Invoke-WebRequest "$release/qs_dmss-0.10.1-py3-none-any.whl" -OutFile "qs_dmss-0.10.1-py3-none-any.whl"
python -m pip install .\qs_dmss-0.10.1-py3-none-any.whl
```
...
```bash
release="https://github.com/AI-Bio-Synergy-Holdings-LLC/QS-DMSS/releases/download/v0.10.1"
python -m pip install "$release/qs_dmss-0.10.1-py3-none-any.whl"
```
