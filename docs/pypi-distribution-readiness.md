...
- Current release files:
  - `qs_dmss-0.2.0-py3-none-any.whl`
  - `qs_dmss-0.2.0.tar.gz`
...
```powershell
python -m pip install --no-cache-dir qs-dmss==0.2.0
qs-dmss run-demo
...
- `tag`: the final release tag, such as `v0.2.0`
...
python -m pip install .\dist\qs_dmss-0.2.0-py3-none-any.whl
qs-dmss run-demo
qs-dmss campaigns run-demo
```
