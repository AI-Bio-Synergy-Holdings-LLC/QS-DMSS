...
| Installable package | PyPI `qs-dmss==0.11.0`, release wheel, Trusted Publishing, fresh-install smoke | Ready | `v0.11.0` carries the Hosted Studio cockpit, scientific comparison workbooks, Fractal/Quadrant SSFM validation spine, public reference-data provenance sandbox, Conceptual Reference Map links, and job-registry path hardening; archived release DOI is `10.5281/zenodo.21319023` |
