...
Current release target: `v0.2.0` / `0.2.0`. Published release-candidate tags
...
- Python package metadata uses the equivalent PEP 440 form, such as
  `0.1.0rc1`.
- Final releases use matching final versions: Git tags such as `v0.2.0` and
  package versions such as `0.2.0`.
