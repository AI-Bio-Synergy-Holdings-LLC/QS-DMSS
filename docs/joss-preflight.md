...
| Installable package | GitHub v0.13.0 release wheel, PyPI `qs-dmss==0.12.0`, Trusted Publishing, fresh-install smoke | Ready with PyPI publication pending | `v0.13.0` adds the live harness, Research Runbook, and contextual Evidence Assistant; archived release DOI is `10.5281/zenodo.21348257`. Publish the exact GitHub release artifacts to PyPI through Trusted Publishing. |
