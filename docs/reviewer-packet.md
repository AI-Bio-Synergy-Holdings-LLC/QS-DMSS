...
cross-platform GitHub release-wheel commands and the PyPI baseline context.
...
The `v0.13.2` package includes the canonical simulation showcase for
...
`v0.13.2` carries the simulator-first quantum-readiness evidence path, the
