...
def test_cockpit_shell_has_accessible_navigation_and_landmarks() -> None:
    ...
    assert '<meta name="application-version" content="0.13.2" />' in html
    ...
    assert "Build v0.13.2" in html
    assert "Latest archive v0.13.1 DOI 10.5281/zenodo.21348597" in html
