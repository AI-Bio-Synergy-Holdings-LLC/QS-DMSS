...
simulation workflows. The current alpha release combines a NumPy-based
split-step solver with deterministic run ledgers, manifest-verified evidence
bundles, replay and verification commands, template-driven decision campaigns,
...
until the author list, field comparison, research-use evidence, and public
development-history expectations are satisfied.
...
PyPI distribution, Zenodo DOI archival [@qsdmss014], CI across Python 3.10
