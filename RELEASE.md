...
Current release target: `v0.8.0` / `0.8.0`. Published release-candidate tags
...
- Python package metadata uses the equivalent PEP 440 form, such as
  `0.1.0rc1`.
- Final releases use matching final versions: Git tags such as `v0.3.0` and
  package versions such as `0.3.0`.
