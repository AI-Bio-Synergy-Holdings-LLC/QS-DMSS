...
Wheel:
`https://github.com/AI-Bio-Synergy-Holdings-LLC/QS-DMSS/releases/download/v0.1.3/qs_dmss-0.1.3-py3-none-any.whl`
...
```powershell
$release = "https://github.com/AI-Bio-Synergy-Holdings-LLC/QS-DMSS/releases/download/v0.1.3"
Invoke-WebRequest "$release/qs_dmss-0.1.3-py3-none-any.whl" -OutFile "qs_dmss-0.1.3-py3-none-any.whl"
python -m pip install .\qs_dmss-0.1.3-py3-none-any.whl
```
