...
- DOI status: `v0.6.0` archived by Zenodo
- PyPI metadata refresh: `v0.6.1` republishes the corrected `v0.6.0`
  archive DOI in package metadata without changing simulation behavior
