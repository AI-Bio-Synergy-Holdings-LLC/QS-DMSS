...
- Current release target: `v0.8.0` / `0.8.0`
...
- Keeps the latest archived DOI pointed at `v0.7.0` until Zenodo archives
  `v0.8.0`, then updates citation metadata in the next DOI metadata PR.
